...
var cart = {
  'addcart': function(product_id, quantity) {
    $.ajax({
      url: '../../../../process.ajax.php?route=checkout/cart/add',
      type: 'post',
      ...
      success: function(json) {
        ...
        if (json['success']) {
          ...
          $('#cart > ul').load('../../../../process.ajax.php?route=common/cart/info ul li');
        }
      }
    });
  },
  'update': function(key, quantity) {
    $.ajax({
      url: '../../../../process.ajax.php?route=checkout/cart/edit',
      type: 'post',
      ...
      success: function(json) {
        ...
        if (getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') {
            location = '../../../../process.ajax.php?route=checkout/cart';
        } else {
            $('#cart > ul').load('../../../../process.ajax.php?route=common/cart/info ul li');
  ...
  'remove': function(key) {
    $.ajax({
      url: '../../../../process.ajax.php?route=checkout/cart/remove',
      type: 'post',
      data: 'key=' + key,
      dataType: 'json',
      beforeSend: function() {
...
var wishlist = {
  'addwishlist': function(product_id) {
    $.ajax({
      url: '../../../../process.ajax.php?route=account/wishlist/add',
      type: 'post',
...
var compare = {
  'addcompare': function(product_id) {
    $.ajax({
      url: '../../../../process.ajax.php?route=product/compare/add',
      type: 'post',
      data: 'product_id=' + product_id,
      dataType: 'json',
      success: function(json) {
...
$(window).ready( function(){
  ...
  $('#pav-mainnav input[name=\'search\']').parent().find('span').on('click', function() {
    url = $('base').attr('href') + '../../../../busqueda.php?';

...
$DefaultFrom = "Easy&FreshPR.com <no.responder@elgigantedelosazulejosgrupo100.com>";
...
/* probado hasta aqui*/response_message = $json->message;
...
/* !kQm*fF3pXe1Kbm%9 *//*
function Encrypt_String2($decrypted, $password='MyHostMX2', $salt='No!') {
...
function Decrypt_String2($encrypted, $password='MyHostMX2', $salt='No!') {
// Build a 256-bit $key which is a SHA256 hash of $salt and $password.
$key = hash('SHA256', $salt . $password, true);

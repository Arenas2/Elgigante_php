...
<li key="pdf_url"><?php echo $pdf_file; ?></li>
...
<!-- BEGIN BACK BUTTON -->
<a href="../../" id="fb5-button-back">&lt; Regresar</a>
<!-- END BACK BUTTON -->
...
<!-- begin links for PAGE 1 -->
<div data-page="1" class="links">
<a href="../../" target="_blank">
<div class="link" style="left:0px;top:0px;width:0px;height:0px"></div>
</a>
</div>
<!-- end links for PAGE 1 -->
...
<img alt="" src="../../images/logo.png" height="40">
</a>
...
<!-- icon download -->
<li>
<a title="download pdf" class="fb5-download" href="<?php echo $pdf_file; ?>"><i class="fa fa-download"></i></a>
</li>

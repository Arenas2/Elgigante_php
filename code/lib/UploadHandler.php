...
// $url_server = url_server();
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME'))."/files/".$GLOBALS['cosa']."/".$GLOBALS['id_cosa']."/",
           // 'upload_url' => $this->get_full_url()."/files/".$GLOBALS['cosa']."/".$GLOBALS['id_cosa']."/",
...
$data = $files;
foreach($data as $var_r)
{
$Id_Img = $GLOBALS['random'];
$Nombre_Img = $var_r->name;
$Usuario = $GLOBALS['Data_Usuario'];
$FechaHora = time();
$Tamano = $var_r->size;
$Tipo = $var_r->type;
$Url = $var_r->url;
...
`Id_Img`, `Nombre_Img`, `Usuario`, `FechaHora`, `Tamano`, `Img_Tipo`, `Url`, `Tipo`, `Id_Tipo`, `Url_S3`
) VALUES (
'$Id_Img', '$Nombre_Img', '$Usuario', '$FechaHora', '$Tamano', '$Tipo', '$Url', '".$GLOBALS['cosa']."', '".$GLOBALS['id_cosa']."', '$Url_S3'
);";

...
<td><a href="javascript:;" id_pedido="{$Id_Pedido}" class="btn btn-success btn-xs ver_info_pedido" data-toggle="modal" data-target="#modal" style=""><i class="fa fa-share-square-o" aria-hidden="true"></i> {$Estatus}</td>

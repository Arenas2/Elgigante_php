...
<h3 class="panel-title"><b><?php echo $num_Productos_Categorias; ?></b> Categor&iacute;as de <b><?php echo $Title; ?></b><span id="total_all_regs"></span></h3>
</div>
...
?>
<script>
$("#total_all_regs").html(", con un total de <b><?php echo $total_all_regs; ?></b> registros.");
</script>

<div class="row">
<div class="col-sm-3">
<div align="center">
<a href="Editar_Categoria.php?id_cat=0" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Categor&iacute;a</a>
</div>
